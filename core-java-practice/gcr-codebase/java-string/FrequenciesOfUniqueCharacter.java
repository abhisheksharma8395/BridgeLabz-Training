// This program takes input for string and tells the frequencies of all Unique Characters in the String .

import java.util.Scanner;
public class FrequenciesOfUniqueCharacter {
