// This program calculate the BMI of multiple person after taking the input of their weight and height
...
public class BMICalculatorArray {
    ...
    public static void main(String[] args) {
        ...
        // Arrays to store data like weight in kg heights in cm and BMI and status of person
