...
abstract class EmployeeInformation implements Department {
    ...
    // Constructor
    public EmployeeInformation(int employeeId, String name, double baseSalary) {
...
class FullTimeEmployee extends EmployeeInformation {
...
class PartTimeEmployee extends EmployeeInformation {
...
public class EmployeeManagementApp {
    public static void main(String[] args) {
        ...
        EmployeeInformation[] employees = new EmployeeInformation[3];
