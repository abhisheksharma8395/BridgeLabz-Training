...
abstract class ProductsInfo {
    private int productId;
    private String name;
    private double price;

    // Constructor
    public ProductsInfo(int productId, String name, double price) {
...
class Electronics extends ProductsInfo implements Taxable {
...
class Clothing extends ProductsInfo implements Taxable {
...
class Groceries extends ProductsInfo {
...
public class ECommercePlatform {
    public static void main(String[] args) {
        ProductsInfo[] products = new ProductsInfo[4];
