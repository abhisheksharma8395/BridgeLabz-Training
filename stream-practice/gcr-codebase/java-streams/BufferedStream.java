...
public class BufferedStream {
    public static void main(String[] args) {
        String inputFile = "C:\\path\\to\\input_large_file.txt";       //  change this
        String outputBuffered = "C:\\path\\to\\output_buffered.txt";
        String outputUnbuffered = "C:\\path\\to\\output_unbuffered.txt";
